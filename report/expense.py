...
def print_reports(root_account, expense_config, time_delta):
    years = expense_config['years']
    exclude_parents = expense_config['exclude_parents']
    exclude_children = expense_config['exclude_children']

    for year in years:
        __print_report(root_account, year, time_delta, exclude_parents, exclude_children)


def __print_report(root_account, year, time_delta, exclude_parents, exclude_children):
